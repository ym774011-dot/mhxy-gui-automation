...
# 确保背包开
if M._lua_expr(GW, "tostring(tp.窗口.道具行囊.可视 or false)") != "true":
    print("打开背包:", M._open_bag(GW))
time.sleep(0.4)
print("背包可视:", M._lua_expr(GW, "tostring(tp.窗口.道具行囊.可视 or false)"))
...
time.sleep(1.0)
print("右键卡后 对话栏状态:", M._member_dialog_state(GW))
print("---- 根菜单选项(文字+跳转+中心) ----")
print(lua(r'''
local d=tp.窗口.对话栏
local out={}
if d and d.选项 then
